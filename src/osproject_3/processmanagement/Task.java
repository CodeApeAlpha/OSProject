...
public class Task 
{
	...
	public void runTask(int taskNum, Process process)
	{
 		initializeResourceList();
		switch (taskNum) 
		{
			case 1: 
				System.out.println("\nProcess " + process.getPid()+ " Adding Record to Shared Resource List");
				addRecord();
//				System.out.println("Shared Resource List After Updating Record");
//				viewSharedResourceList();
				break;
			case 2: 
				System.out.println("\nProcess " + process.getPid()+ " Removing Record from Shared Resource List");
				removeRecord();
//				System.out.println("Shared Resource List After Removing Record");
//				viewSharedResourceList();
				break;
			case 3: 
				System.out.println("\nProcess " + process.getPid()+ " Retrieving Record from Shared Resource List");
				retrieveRecord();
				break;
			case 4:
				System.out.println("\nProcess " + process.getPid()+ " Calculating Shared Resource List Data Values");
